package com.peach.community.test;
...
import com.peach.community.domain.TestVO;

public class JsonExam1 {
   public static List<Object> main() {
	   List<Object> dayTest=new ArrayList<Object>();
	   int a=0;
            ...
            if(node.isArray()) {
               for(JsonNode n:node) {
                  ...
                  if(n.get("countyname").asText().equals("평균")) {
                     ...
                     dayTest.add(n.get("yyyy").asText()+"/"+n.get("regday").asText());
                     a++;
                  }
...
//
      ...
      dayTest=dayTest.subList(a-30,a);
      return dayTest;
